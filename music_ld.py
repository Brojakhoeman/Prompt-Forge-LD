...
MUSIC_LAW_MIX = (
    ...
    "5) Singing only if the intent asks; otherwise music scores / drives motion and room energy.\n"
...
MUSIC_LAW_BG = (
    "━━ MUSIC / SOUNDTRACK (BACKGROUND — QUIET UNDER) — HARD OVERRIDE ━━\n"
    "This mode BEATS loud genre clichés, club intent flavour, and mouth-heat 'shouted' voice.\n"
    ...
    "   GOOD: '…kneels, mouth stretched wide… A faint techno kick ticks under the room.'\n"
    ...
    "Never describe it as loud, deafening, room-shaking, vibrating glass/walls, thumping through the floor, "
    ...
    "   GOOD: says (intense): \"…\" / calls out / voice rough and close — while a faint beat stays under the room.\n"
    "   Crowd can cheer or the room can feel busy if the INTENT asks — that is people energy, NOT loud music prose.\n"
    ...
    "6) MOTION: do NOT force hip hits on every kick. Wallpaper score only unless intent also demands dance-floor hits.\n"
    "7) Singing only if intent asks. Prefer soft score words over performance words.\n"
    "\n"
    "QUIET PRESET (this is the only music texture — ignore any loud club-mix memory):\n"
)
